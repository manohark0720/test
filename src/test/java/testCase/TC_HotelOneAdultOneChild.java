...
public class TC_HotelOneAdultOneChild  extends BaseClass {
	...
	Thread.sleep(5000);
			...
			Thread.sleep(2000);
			ho.setSalution();
			ho.setFirstName("thanaya");
			sleep();
			ho.setLastName();
	Thread.sleep(5000);

			datepicker("//*[@id='bookingSummary:return']", "08", "Mar-2000", "//*[@class='ui-datepicker-year']","//*[@class='ui-datepicker-month']", "User select the date as " ," TesterName");
			Thread.sleep(1000);
			ho.setNationality1();
			Thread.sleep(1000);
			ho.setNumCode();
