...
import io.cucumber.java.en.Given;
	...
	WebDriver driver;
		...
		public void the_user_enters_valid_credentials_username_password(String email, String pwd) {
			...
			driver.findElement(By.xpath("/html//input[@id='Password']")).sendKeys(pwd);
			
		}

		@When("the user clicks on0 the Login button")
		...
		public void the_user_should_be_redirected_to_the_my_account_page() {
			...
			boolean status=driver.findElement(By.xpath("/html//div[@class='master-wrapper-page']/div[@class='header']//div[@class='header-links']/ul//a[@href='/customer/info']")).isDisplayed();
